...
import VolunteerManagement from "./VolunteerManagement.jsx";
import DonorInsights from "./DonorInsights.jsx";
import "./NGODashboard.css";
import ServiceProviderCoordination from "./ServiceProviderCoordination.jsx";
...
            </Nav.Item>
            <Nav.Item>
              <Nav.Link eventKey="volunteers">Volunteer Management</Nav.Link>
            </Nav.Item>
<Nav.Item>
  <Nav.Link eventKey="donors">Donor Insights</Nav.Link>
</Nav.Item>
<Nav.Item>
  <Nav.Link eventKey="serviceproviders">ServiceProvider Coordination</Nav.Link>
</Nav.Item>
<Nav.Item>
  <Nav.Link eventKey="vouchers">Voucher Management</Nav.Link>
</Nav.Item>
...
              <Card>
                <Card.Header>
                  <h6 className="fw-bold mb-0">Volunteer Management</h6>
                  <small className="text-muted">
                    Oversee, analyze, and engage NGO volunteers
                  </small>
                </Card.Header>
                <Card.Body>
                  <VolunteerManagement />
...
            </Tab.Pane>
            ...
            <Tab.Pane eventKey="donors">
              <Card>
                <Card.Header>
                  <h6 className="fw-bold mb-0">Donor Insights</h6>
                  <small className="text-muted">
                    Analyze donor engagement and funding impact
                  </small>
                </Card.Header>
                <Card.Body>
                  <DonorInsights />
            ...
            <Tab.Pane eventKey="serviceproviders">
              <Card>
                <Card.Header>
                  <h6 className="fw-bold mb-0">ServiceProvider Coordination</h6>
                </Card.Header>
                <Card.Body>
             ...
             <Tab.Pane eventKey="vouchers">
              <Card>
                <Card.Header>
                  <h6 className="fw-bold mb-0">Voucher Management</h6>
                </Card.Header>
                <Card.Body>
